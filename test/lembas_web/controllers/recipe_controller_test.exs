defmodule LembasWeb.RecipeControllerTest do
  use LembasWeb.ConnCase

  alias Lembas.Recipes

  @create_attrs %{cooking_time: ~T[14:00:00], instructions: "some instructions", name: "some name", yield: 42}
  ...
  describe "update recipe" do
    ...
    test "redirects when data is valid", %{conn: conn, recipe: recipe} do
      ...
      assert html_response(conn, 200) =~ "some updated instructions"
    end
